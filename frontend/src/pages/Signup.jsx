      ...
      <div className="lgg:w-1/3 w-full p-10 bg-black">
        ...
        <form onSubmit={handalsubmit} className="space-y-6">
          ...
          <div className="relative">
            ...
            >
              <path
                d="M12.5 13.125C12.5 12.2528 12.5 11.8167 12.3924 11.4618C12.15 10.6628 11.5247 10.0375 10.7257 9.79513C10.3708 9.6875 9.93475 9.6875 9.0625 9.6875H5.9375C5.06527 9.6875 4.62916 9.6875 4.27429 9.79513C3.47528 10.0375 2.85002 10.6628 2.60765 11.4618C2.5 11.8167 2.5 12.2528 2.5 13.125M10.3125 4.6875C10.3125 6.2408 9.05331 7.5 7.5 7.5C5.9467 7.5 4.6875 6.2408 4.6875 4.6875C4.6875 3.1342 5.9467 1.875 7.5 1.875C9.05331 1.875 10.3125 3.1342 10.3125 4.6875Z"
                stroke="white"
            ...
            >
              ...
              {!loading ? (
                ...
                <div className=" bg-[#b2b4c3]">
                  <svg
                    className=" absolute top-1 opacity-80 bg-[#717EFF] p-1 rounded-full right-1"
                    width="33"
                    height="33"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 200 200"
...
//         try {
//             // Make POST request to the backend signup endpoint
//             const response = await axios.post('http://localhost:8000/api/auth/signup', formData);

//             // Handle response
//             if (response.status === 200) {
//                 // Navigate to login or dashboard page on successful signup
//                 navigate('/dashboard');
//             } else {
...
//                 <p className="text-right text-[#8997A6] my-4 font-medium text-xs">
//                     Already a member?{' '}
//                     <span onClick={() => navigate('/login')} className="text-[#BA7E7E] cursor-pointer">
//                         Sign in
//                     </span>
//                 </p>
...
//                     {/* Signup Button */}
//                     <button type="submit" className="w-full bg-[#BA7E7E] text-[#FDFCFF] text-xl py-3 rounded-md">
//                         Sign Up
//                     </button>
//                 </form>
//             </div>
